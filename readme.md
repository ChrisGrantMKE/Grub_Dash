...
While writing this there was some code suggestions and syntax corrections NOT CODE GENERATION. 
AI helped me get this integrated with the front end code from github for testing, AI looked at the front end code and showed me how to connect the app to my server using `REACT_APP_API_BASE_URL`.
...
original contributions are in the dishes and orders folders. 
    (dishes.router.js, dishes.controller.js, orders.router.js, orders.controller.js )

Milestones were 
1 - setting up the files in github
2 - getting the scaffolding set up 
3 - setting up dishes and orders routers
4 - getting the dishes controller files done
5 - getting the orders controller done
6 - testing this while local host
7 - getting Morgan set up 
8 - troubleshooting and testing in qualfied
...
with Morgan running i was able to see there was some intial issues with some of my routes actually getting called properly and the site didnt get the data pulled up properly at first. ( it wasnt seeing any requests )
once morgan was up and running i was able to test around with postamn a bit and see the codes i was getting for different requests, making sure the codes were properly matched with messages. 
